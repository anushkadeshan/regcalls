...
export default {
    ...
    methods: {
        ...
        SaveTranslation: function () {
            this.form.post(route('editEnTranslation'),{
                preserveState: true,
                preserveScroll: true,
                onSuccess: (page) => {
                    console.log("sdsd");
...
<template>
    <Translations :crumbs="crumbs">
        <div class="md:overflow-y-auto md:h-96">
            ...
            <div v-for="(value, key) in en"  :key="key" class="flex justify-between bg-gray-50 border border-gray-200">

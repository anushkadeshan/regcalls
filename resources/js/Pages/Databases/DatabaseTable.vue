...
<template lang="">
    <div class="my-4">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="py-3 px-6">
                            <span @click="sort('connection')" class="flex space-x-4">
                                {{$t('Connection')}}
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 7.5L7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5" />
                                </svg>
                        ...
                        <th scope="col" class="py-3 px-6">
                            <span @click="sort('database')" class="flex space-x-4">
                                {{$t('Database')}}
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 7.5L7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5" />
                                </svg>
                        ...
                        <th scope="col" class="py-3 px-6">
                            <span @click="sort('host')" class="flex space-x-4">
                                {{$t('Host')}}
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 7.5L7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5" />
                                </svg>
                        ...
                        <th scope="col" class="py-3 px-6">
                            <span @click="sort('port')" class="flex space-x-4">
                                {{$t('Port')}}
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 7.5L7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5" />
                                </svg>
                ...
                <tbody>
                    <tr v-if="databases.data.length >0"  v-for="(database, key) in databases.data" :key="database.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="py-2 px-6">
                            ...
                            <div class="inline-flex rounded-md shadow-sm">
                                ...
                                <Link :href="route('databases.edit',[database.id])" class="px-2 py-1 bg-gradient-to-r from-green-500 to-green-600 hover:opacity-80 text-white text-sm font-medium rounded-md">
        ...
        <Pagination :links="databases.links" :to_items="databases.to" :from_items="databases.from" :total_items="databases.total"></Pagination>
    </div>
